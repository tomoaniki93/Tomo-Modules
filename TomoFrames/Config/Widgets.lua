...
W.Theme = {
    ...
    accent       = { 0.961, 0.620, 0.043, 1 },     -- #0cd29f tomo green
    accentDark   = { 0.740, 0.480, 0.030, 1 },
    ...
    textHeader   = { 0.961, 0.620, 0.043, 1 },
...
local FONT_BOLD = "Interface\\AddOns\\TomoFrames\\Assets\\Fonts\\Poppins-SemiBold.ttf"
