...
W.Theme = {
    ...
    accent       = { 0.545, 0.361, 0.965, 1 },     -- #8b5cf6 tomo green
    accentDark   = { 0.420, 0.270, 0.780, 1 },
    accentHover  = { 0.620, 0.440, 1.000, 1 },
    border       = { 0.20, 0.20, 0.25, 1 },
    borderLight  = { 0.30, 0.30, 0.35, 1 },
    text         = { 0.90, 0.90, 0.92, 1 },
    textDim      = { 0.55, 0.55, 0.60, 1 },
    textHeader   = { 0.545, 0.361, 0.965, 1 },
...
local FONT_BOLD = "Interface\\AddOns\\TomoPlates\\Assets\\Fonts\\Poppins-SemiBold.ttf"
