...
TomoSkins_CS = TomoSkins_CS or {}
local CS = TomoSkins_CS
...
local function GetSettings()
    return TomoSkinsDB and TomoSkinsDB.characterSkin or {}
end
...
function CS.ApplySettings()
    if isInitialized then
        ...
        print("|cfff43f5eTomoSkins|r " .. (L["msg_char_skin_reload"] or "Character Skin: /reload to apply changes."))
    end
end
