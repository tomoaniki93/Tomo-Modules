...
TomoSkins_ABS = TomoSkins_ABS or {}
local ABS = TomoSkins_ABS

-- =====================================
-- CONSTANTES
-- =====================================
local FONT = "Interface\\AddOns\\TomoSkins\\Assets\\Fonts\\Poppins-SemiBold.ttf"
local BORDER_TEX = "Interface\\AddOns\\TomoSkins\\Assets\\Textures\\Nameplates\\border.png"
...
local function GetSettings()
    if not TomoSkinsDB or not TomoSkinsDB.actionBarSkin then return nil end
    return TomoSkinsDB.actionBarSkin
end
...
function ABS.SetEnabled(enabled)
    ...
    if enabled then
        ...
        print("|cfff43f5eTomoSkins|r " .. TomoMod_"Action bars skin activé.")
    else
        -- Disable combat frame when skin is disabled
        combatFrame:UnregisterAllEvents()
        combatFrame:Hide()
        HideSkin()
        print("|cfff43f5eTomoSkins|r " .. TomoMod_"Action bars skin désactivé.")
    end
end
