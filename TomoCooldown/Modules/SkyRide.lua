...
TomoCooldown_SR = TomoCooldown_SR or {}
local SR = TomoCooldown_SR
...
local function GetSettings()
    if not TomoCooldownDB or not TomoCooldownDB.skyRide then
        return nil
    end
    return TomoCooldownDB.skyRide
end
...
local function CreateUI()
    ...
    -- Frame principal
    frame = CreateFrame("Frame", "TomoCooldownSkyRideFrame", UIParent)
...
function SR.Initialize()
    if not TomoCooldownDB then
        print("|cffff4444TomoCooldown|r " .. "DB non initialisée.")
        return
    end
    
    -- Initialiser les settings si nécessaire
    if not TomoCooldownDB.skyRide then
        TomoCooldownDB.skyRide = {
    ...
    print("|cff06b6d4TomoCooldown|r " .. "Skyriding initialisé.")
end

-- Export
_G.TomoCooldown_SR = SR
