...
TomoCooldown_CDM = TomoCooldown_CDM or {}
local CDM = TomoCooldown_CDM

-- =====================================
-- CONSTANTES
-- =====================================
local FONT = "Interface\\AddOns\\TomoCooldown\\Assets\\Fonts\\Poppins-SemiBold.ttf"
local BORDER_TEX = "Interface\\AddOns\\TomoCooldown\\Assets\\Textures\\Nameplates\\border.png"
...
local function GetSettings()
    return TomoCooldownDB and TomoCooldownDB.cooldownManager
end
...
function CDM.Initialize()
    ...
    if not TomoCooldownDB.cooldownManager then
        TomoCooldownDB.cooldownManager = {
            enabled = true,
            showHotKey = false,
            combatAlpha = true,
            alphaInCombat = 1.0,
