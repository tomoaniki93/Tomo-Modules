...
TomoCooldown_Widgets = {}
local W = TomoCooldown_Widgets
...
W.Theme = {
    ...
    accent       = { 0.024, 0.714, 0.831, 1 },     -- #0cd29f tomo green
    accentDark   = { 0.018, 0.540, 0.640, 1 },
    ...
    textHeader   = { 0.024, 0.714, 0.831, 1 },
...
local FONT_BOLD = "Interface\\AddOns\\TomoCooldown\\Assets\\Fonts\\Poppins-SemiBold.ttf"
